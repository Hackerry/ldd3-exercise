...
// HACKERRY-UPDATE: SPIN_LOCK_UNLOCKED are replaced with DEFINE_SPINLOCK
...
static int scull_u_open(struct inode *inode, struct file *filp)
{
	...
	if (scull_u_count && 
			// HACKERRY-UPDATE: struct task_struct now has id info in struct cred *cred - https://elixir.bootlin.com/linux/v6.14.5/source/include/linux/sched.h#L1134
